...
import { FileNavigatorSettings, HistorySettings, LocaleSettings, SettingsChangedEvent, ViewSettings } from "../types/SettingsChangedEvent";
...
export const useSettingsChange = () => {
     ...
     */
    const applyViewSettings = useCallback((settings: ViewSettings) => {
     ...
     */
    const applyHistorySettings = useCallback((settings: HistorySettings) => {
     ...
     */
    const applyFileNavigatorSettings = useCallback((settings: FileNavigatorSettings) => {
     ...
     */
    const handleSettingsChanged = useCallback((event: { payload: SettingsChangedEvent }) => {
