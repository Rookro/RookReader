...
export const commands = {
	 ...
	 */
	setPdfRenderResolutionHeight: (height: number) => typedError<null, CommandError>(__TAURI_INVOKE("set_pdf_render_resolution_height", { height })),
	/**
	 ...
	 */
	setMaxImageHeight: (height: number) => typedError<null, CommandError>(__TAURI_INVOKE("set_max_image_height", { height })),
	/**
	 ...
	 */
	setImageResamplingMethod: (method: string) => typedError<null, CommandError>(__TAURI_INVOKE("set_image_resampling_method", { method })),
	/**
	 ...
	 *  A `Result` which is `Ok` on successful update.
	 */
	setImageCacheSizeMib: (sizeMib: number) => typedError<null, CommandError>(__TAURI_INVOKE("set_image_cache_size_mib", { sizeMib })),
	/**
