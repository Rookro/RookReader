...
* Added folder support inside ZIP and RAR archives, so each folder can be read as its own book.
...
* Fixed an issue where files with Shift-JIS encoded names in ZIP archives could not be read. (#211)
